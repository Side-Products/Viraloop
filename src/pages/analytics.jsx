			...
			<DashboardLayout>
				<div className="p-6">
					...
					<div className="mb-8">
						...
						<p className="text-neutral-500 mt-1">Track performance across all your connected platforms</p>
					</div>
					...
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
						...
						<div className="card p-6">
							<div className="flex items-center justify-between">
								<div>
									<p className="text-neutral-500 text-sm">Total Likes</p>
									<p className="text-3xl font-bold text-neutral-900 mt-1">0</p>
									<p className="text-success-600 text-sm mt-1">+0% this week</p>
								</div>
						...
						<div className="card p-6">
							<div className="flex items-center justify-between">
								<div>
									<p className="text-neutral-500 text-sm">Total Comments</p>
									<p className="text-3xl font-bold text-neutral-900 mt-1">0</p>
									<p className="text-success-600 text-sm mt-1">+0% this week</p>
								</div>
						...
						<div className="card p-6">
							<div className="flex items-center justify-between">
								<div>
									<p className="text-neutral-500 text-sm">Total Shares</p>
									<p className="text-3xl font-bold text-neutral-900 mt-1">0</p>
									<p className="text-success-600 text-sm mt-1">+0% this week</p>
								</div>
						...
						<div className="card p-6">
							...
							<div className="space-y-3">
								<div className="flex justify-between">
									<span className="text-neutral-500 text-sm">Views</span>
								...
								<div className="flex justify-between">
									<span className="text-neutral-500 text-sm">Comments</span>
									<span className="font-medium text-neutral-900">0</span>
								</div>
							</div>
						</div>
